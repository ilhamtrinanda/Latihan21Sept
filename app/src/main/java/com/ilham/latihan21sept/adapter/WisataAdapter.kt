package com.ilham.latihan21sept.adapter
...
import com.ilham.latihan21sept.MainActivity
import com.ilham.latihan21sept.R
import com.ilham.latihan21sept.ScreenSplashActivity
import com.ilham.latihan21sept.model.WisataModel
    ...
    RecyclerView.Adapter<WisataAdapter.MyViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: WisataAdapter.MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            val intent = Intent(getActivity, ScreenSplashActivity::class.java)
